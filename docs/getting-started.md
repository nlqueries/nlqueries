...
- Python 3.11–3.14 **or** Docker + Docker Compose.
- A running PostgreSQL, MySQL, Snowflake, BigQuery, Redshift, SQL Server/Azure SQL, DuckDB, or SQLite database (SQLite and DuckDB are file-based and need no server)
